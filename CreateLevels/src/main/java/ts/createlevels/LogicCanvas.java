...
{
    public static final byte sizeHistory = 100;
    public static float sizeCell = 30;
    public static boolean isDefaultCell = false, isChoiceColor = false, isClosed = false;
    ...
    public static String comboPouringIndex = "Кисть";

    protected static void addHistory(String[] list)
    {
        listHistory.add(list);
        if(listHistory.size() >= sizeHistory)
        {
    ...
    protected static void sizeCellVoid(boolean isMin, Stage stage, BorderPane border)
    {
