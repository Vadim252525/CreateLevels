...
public class ProgramSettings
{
    ...
    public static boolean isCanvasOpen = false, isWindowCloseRequestEvent = false;
    public static String pathExport = System.getProperty("user.home") + "/Desktop";
    ...
    public static BackgroundFill bgFill()
    {
        return new BackgroundFill(
                new LinearGradient(0, 0, 1, 1, true, CycleMethod.NO_CYCLE,
                        new Stop(0, Color.web("#3a3a3a")),
                        new Stop(0.25f, Color.web("#222222")),
                        new Stop(1, Color.BLACK)),
                CornerRadii.EMPTY,
                Insets.EMPTY);
    }
    public static BackgroundFill bgSceneFill()
    {
        return new BackgroundFill(Color.web("#121212"), CornerRadii.EMPTY, Insets.EMPTY);
    }
